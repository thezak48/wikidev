...
> 커밋하기 전에 프론트엔드 변경 사항에 대해 코드에서 `yarn lint --fix`를 실행하세요.
...
항상 재미있지는 않지만, 백엔드 코드 변경에 대해 단위 테스트를 작성하는 것을 권장합니다. 이렇게 하면 변경 사항이 의도한 대로 작동하고 미래의 변경 사항이 예상된 동작을 깨뜨리지 않는지 확인할 수 있습니다.
