...
- Om versionen är identisk kan du växla, annars kontrollera med utvecklingsteamet om du kan växla från `nightly` till `master`; `nightly` till `develop`; eller `develop` till `master` för din specifika byggnad.
